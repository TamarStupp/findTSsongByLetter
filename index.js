...
let songs = ['A Message From Taylor',
...
songs = songs.map(letter => letter.toLowerCase());

window.addEventListener('load', () => {
    document.getElementById('go-existing').addEventListener('click', handleInputExist);
    document.getElementById('go-missing').addEventListener('click', handleInputMissing);
})
